...
myApp.controller('homeReservationSearch', function ($scope, $http, $timeout, $window, AppContext, Enum) {
    ...
    ons.ready(function () {
        ...
        $scope.search = function () {
            ...
            var request = {
                method: 'GET',
                url: "http://mediapp.host78.com/search.php?Brand=" + $scope.info.customerName + "&Chemical=",
            }
        ...
        $scope.view = function (id) {
            $scope.homeNavigator.pushPage('viewAgreement.html', { animation: defaultTransition, id: id });
        }
    });
